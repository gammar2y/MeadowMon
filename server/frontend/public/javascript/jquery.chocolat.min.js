...
function(t) {
  ...
  function n(e, i) {
    ...
    !this.settings.setTitle && e.data("chocolat-title") && (this.settings.setTitle = e.data("chocolat-title")),
    ...
    this.element.find(this.settings.imageSelector).each(function(e) {
      t(this).off("click.chocolat").on("click.chocolat",
      function(t) {
        s.init(e),
        t.preventDefault()
      })
  ...
  t.extend(n.prototype, {
    init: function(t) {
      return this.settings.initialized || (this.setDomContainer(), this.markup(), this.events(), this.settings.lastImage = this.settings.images.length - 1, this.settings.initialized = !0),
    ...
    load: function(e) {
      ...
      if (this.settings.fullScreen && this.openFullScreen(), this.settings.currentImage !== e) {
        ...
        var s = this.preload(e).then(function(t) {
          ...
          i.zoomable(),
          i.settings.afterImageLoad.call(i)
        }),
        n = e + 1;
        return "undefined" != typeof this.settings.images[n] && this.preload(n),
        s
      }
    },
    place: function(t, e) {
      var i, s = this;
      return this.settings.currentImage = t,
      this.description(),
      this.pagination(),
      this.arrows(),
    ...
    close: function() {
      ...
      return this.settings.currentImage = !1,
      s
    },
    destroy: function() {
      this.element.removeData(),
      this.element.find(this.settings.imageSelector).off("click.chocolat"),
      this.settings.initialized && (this.settings.fullscreenOpen && this.exitFullScreen(), this.settings.currentImage = !1, this.settings.initialized = !1, this.elems.domContainer.removeClass(this._cssClasses.join(" ")), this.elems.wrapper.remove())
    },
    ...
    markup: function() {
      ...
      "cover" == this.settings.imageSize && this.elems.domContainer.addClass("chocolat-cover"),
      this.settings.container !== e && this.elems.domContainer.addClass("chocolat-in-container"),
    ...
    events: function() {
      var s = this;
      t(i).off("keydown.chocolat").on("keydown.chocolat",
      function(t) {
      ...
      t([this.elems.overlay[0], this.elems.close[0]]).off("click.chocolat").on("click.chocolat",
      function() {
        return s.close()
      }),
      ...
      s.settings.backgroundClose && this.elems.overlay.off("click.chocolat").on("click.chocolat",
      function() {
        return s.close()
      }),
      this.elems.wrapper.off("click.chocolat").on("click.chocolat",
      function(t) {
        return s.zoomOut(t)
      }),
      this.elems.wrapper.find(".chocolat-img").off("click.chocolat").on("click.chocolat",
      function(t) {
        if (null === s.settings.initialZoomState && s.elems.domContainer.hasClass("chocolat-zoomable")) return t.stopPropagation(),
        s.zoomIn(t)
      }),
      ...
      t(e).on("resize",
      function() {
        s.settings.initialized && s.settings.currentImage !== !1 && s.debounce(50,
        function() {
